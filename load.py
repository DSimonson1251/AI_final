...
env = RecordVideo(env, video_folder="video", name_prefix="frogger", episode_trigger=lambda x: x == 0)

# Load the pre-trained model
model = DQN.load("dqn_frogger", env=env)
...
if frames:
    imageio.mimsave('frogger.gif', frames, fps=30)
else:
